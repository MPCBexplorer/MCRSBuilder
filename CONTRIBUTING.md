...
### Reporting Bugs
Before creating bug reports, please check [existing issues](../../issues) to avoid duplicates.Just follow the template.
...
Browse all labeled issues on our [Issues page](../../issues).
